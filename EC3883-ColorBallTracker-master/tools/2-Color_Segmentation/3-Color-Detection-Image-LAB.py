...
def mask2CentroidColor(image, mask, LAB_dictionary):
    ...
    for c in cnts:
        ...
        print("(x,y) = {}, color = {}".format((x,y), color_label))
...
# shifted = cv2.GaussianBlur(image, (5, 5), 0)
...
for cnt in tracked_cnts:
    ...
    cv2.circle(image,center,radius,(color[2], color[1], color[0]),2)

    # Draw a white dot at the center of each ball
    cv2.circle(image, center, 1, (255, 255, 255), -1)
