...
rapidez = 6
PWMrd = 20000#rpd2pwm("rd", rapidez)
PWMri = 17000#rpd2pwm("ri", rapidez)
print(PWMri)
print(PWMrd)
robot_pos, head_vector, balls, obstacles = get_all()  # obtener la posicion del robot
ball = balls[0]
ball_vector = np.array([ball[0] - robot_pos[0], ball[1] - robot_pos[1]])
angle = angle_between(head_vector, ball_vector)
dist_obj = norm_vector(ball_vector)
